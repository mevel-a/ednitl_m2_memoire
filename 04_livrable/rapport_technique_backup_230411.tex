...
Ainsi voit-on \ref{%figureXXXX
}   
l.~%numéros ligne
, l'ajout d'un '0' à la fin des appels générés s'ils ne sont pas les premiers (ou/et les seuls).
