...
Notons que le nettoyage a été effectué en conservant grâce à des commentaires les traces de balises supprimées que l'on pourrait vouloir restaurer (tels les éléments <div> utilisé pour insérer du blanc dans le corps du texte).
