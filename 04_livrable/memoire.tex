...
\newcommand{\int}{\footnote{\textsc{Boschetti}~Anna, \textsc{Sapiro}~Gisèle (dir.~), «~La recomposition de l'espace intellectuel en Europe après 1945~», Paris, La Découverte, \textit{L'Espace intellectuel en Europe}, 2009, p.~147-182
...
\end{quote}
%ils sont en gros d'accord là-dessus
...
\end{quote}
%langage métaphysique ou romantique de Sartre cependant perce un peu.
\begin{quote}
...
\end{quote}
%une explicatio de la divergence ?

%à propos du besoin de signification
\begin{quote}
...
«~les grands écrivains voulaient détruire, édifier, démontrer\footnote{\qql35}.~»

%expliquant la théorie du sens selon els critiques
«~le but profond, c'est de se livrer sans en avoir l'air\footnote{\qql37}.~»
...
%pourtant on trouve les mêmes constats
\begin{quote}
...
%arg se méfie du sens
%redéfinition du sens : signification un positionnement nouveau une nouvelle attitude, en cela finalement peut-être pas si éloigné de Sartre et de l'adresse à la liberté.
...
\begin{quote}
    On peut schématiser (grossièrement) l'opinion de Robbe-Grillet sur osn œuvre en disant qu'il n'a jamais (du moins jusqu'à ce jour) renoncé à son intention réaliste, mais qu'il a prêté à cette injonction un contenu d'abord totalement objectif, puis purement subjectif\footnote{\gege73}.
\end{quote}

%Nous en somems en présence du second Robbe-Grillet, le premier c'est celui des gommes et c'est tout en gros
